...
function transformarResumoLoteV652() {
  ...
  card.innerHTML = `
    <div class="cabecalho-card-v652">
      <div>
        <span class="rotulo-v652">02. Resumo do lote</span>
        <h3>Resumo geral do lote</h3>
      </div>
      <div class="icone-card-v652" aria-hidden="true">02</div>
    </div>
  `;
...
function instalarCardConsumoV652() {
  ...
  card.innerHTML = `
    <div class="cabecalho-card-v652">
      <div>
        <span class="rotulo-v652">01. Automação do trato</span>
  ...
  resumo.parentNode.insertBefore(card, resumo);
}
