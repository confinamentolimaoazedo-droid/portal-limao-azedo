...
function instalarMercadoBoiGordoV67() {
  ...
  card.innerHTML = `
    ...
    <p class="mercado-descricao-v67">
      Contrato contínuo e principais vencimentos
      do futuro de boi gordo negociado na B3.
    </p>
...
function carregarWidgetMercadoV672() {
  ...
  script.textContent = JSON.stringify({
    symbols: [
      ...
      {
        proName: 'BMFBOVESPA:BGIN2026',
        title: 'Jul/26'
      },
      {
        proName: 'BMFBOVESPA:BGIQ2026',
        title: 'Ago/26'
      },
      {
        proName: 'BMFBOVESPA:BGIU2026',
        title: 'Set/26'
      },
      {
        proName: 'BMFBOVESPA:BGIV2026',
        title: 'Out/26'
      },
      {
        proName: 'BMFBOVESPA:BGIX2026',
        title: 'Nov/26'
      },
      {
        proName: 'BMFBOVESPA:BGIZ2026',
        title: 'Dez/26'
      }
    ],
    showSymbolLogo: true,
